...
<head>
    ...
    <title>NovaStore - Yeni Ürün Ekle</title>
                        ...
                        <form action="{{ route('products.store') }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="price" class="form-label fw-bold">Fiyat (TL)</label>
                            ...
                            <div class="mt-4 d-flex justify-content-between">
                                <a href="{{ route('products.index') }}" class="btn btn-secondary">İptal Et / Geri Dön</a>
                                <button type="submit" class="btn btn-success fw-bold">Ürünü Kaydet</button>
                            </div>
                        </form>
